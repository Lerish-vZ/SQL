...
-- 				 FROM table_b
--  			 WHERE table.column = table_b.column);
--UPDATE is main query and the SET and WHERE EXISTS is correlated subqueries (they depend on a value or table name from the main query that surrounds them)
