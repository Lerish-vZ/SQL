...
--Extracting one piece of a date or time value syntax:
-- date_part(text, value)

--The text part represents the date or time to extract ('hour', 'minute' or 'week')
--The second part is the date, time or timestamp value.
...
SELECT '30/09/1929'::date - '27/09/1929'::date;
SELECT '30/09/1929'::date + '5 years'::interval;
