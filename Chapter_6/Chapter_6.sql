...
SELECT *
FROM schools_left JOIN schools_right --will only display those that they have in common
...
SELECT *
FROM schools_left LEFT JOIN schools_right --left table gets advantage
ON schools_left.id = schools_right.id;

-- Listing 6-6: Using RIGHT JOIN

SELECT *
FROM schools_left RIGHT JOIN schools_right --right table gets advantage
ON schools_left.id = schools_right.id;

-- Listing 6-7: Using FULL OUTER JOIN

SELECT *
FROM schools_left FULL OUTER JOIN schools_right -- shows where they do not match, both tables data will be displayed together
ON schools_left.id = schools_right.id;

-- Listing 6-8: Using CROSS JOIN

SELECT *
FROM schools_left CROSS JOIN schools_right; -- will show every possible joins between tables
